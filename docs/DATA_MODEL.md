...
| **"Raise PO from Award"** | Explicit Award → PO linkage (Tender packages, bids, and the award decision record are **implemented** above; V1 deliberately creates no PO and infers no awarded-vs-committed netting) | Transfers the awarded bid's cost-coded amounts into a draft PO |
