...
- **Cash Flow** — *Placeholder.* Time-phased cash-in/cash-out curves and peak funding — the remaining output that closes the project-control loop. Depends on Client Invoices / Accounts Receivable and Payments to be honest. *Planned* (after the Payments/Client Invoices foundation).
